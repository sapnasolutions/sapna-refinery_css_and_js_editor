...
ActiveRecord::Schema.define(:version => 20110429090933) do

  create_table "css_and_js_files", :force => true do |t|
    t.string   "name"
    t.string   "file_type"
    t.text     "content"
    t.integer  "position"
  ...
  create_table "page_footers", :force => true do |t|
    t.integer  "page_id"
    t.integer  "footer_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "pages", :force => true do |t|
    ...
    t.boolean  "is_footer",           :default => false
  end
